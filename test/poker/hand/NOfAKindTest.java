...
class NOfAKindTest {
    ...
    void testBuildWithNOfAKindCards() {
        Optional<HandType> nOfAKind = NOfAKind.build(threeOfAKind, cardsWithThreeOfAKind);
    ...
    void testBuildWithoutNOfAKindCards() {
        Optional<HandType> nOfAKind = NOfAKind.build(threeOfAKind, cardsWithoutThreeOfAKind);
    ...
    void getHighestCardValueWithNOfAKindCards() {
        Optional<Integer> nOfAKindHighestCardValue = NOfAKind.build(threeOfAKind, cardsWithThreeOfAKind).map(HandType::getHighestCardValue);
    ...
    void getHighestCardValueWithoutNOfAKindCards() {
        Optional<Integer> nOfAKindHighestCardValue = NOfAKind.build(threeOfAKind, cardsWithoutThreeOfAKind).map(HandType::getHighestCardValue);
    ...
    void getHighestCardsWithNOfAKindCards() {
        Optional<List<Card>> nOfAKindHighestCards = NOfAKind.build(threeOfAKind, cardsWithThreeOfAKind).map(HandType::getHighestCards);
    ...
    void getHighestCardsWithoutNOfAKindCards() {
        Optional<List<Card>> nOfAKindHighestCards = NOfAKind.build(threeOfAKind, cardsWithoutThreeOfAKind).map(HandType::getHighestCards);
    ...
    void testGetRankWithNOfAKindCards() {
        Optional<Rank> nOfAKindRank = NOfAKind.build(threeOfAKind, cardsWithThreeOfAKind, Optional.of(Rank.THREE_OF_A_KIND)).map(HandType::getRank);
    ...
    void testGetRankWithoutNOfAKindCards() {
        Optional<Rank> nOfAKindRank = NOfAKind.build(threeOfAKind, cardsWithoutThreeOfAKind).map(HandType::getRank);
